    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
            ...
            >
              <div className="inline-flex items-center gap-3 px-4 py-2 bg-yellow-400/10 border border-yellow-400/20 rounded-full mb-6">
                ...
                <span className="text-yellow-400 text-sm font-bold uppercase tracking-wider">Nos Engagements</span>
              </div>
            ...
            >
              <p className="text-2xl md:text-3xl font-light text-gray-300 leading-relaxed">
                Une expertise <span className="text-yellow-400 font-bold">reconnue</span>, des prestations de <span className="text-yellow-400 font-bold">qualité</span> et un service client <span className="text-yellow-400 font-bold">irréprochable</span>
              </p>
            </motion.div>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            >
              <div className="flex flex-col h-full">
                <div className="w-16 h-16 bg-yellow-400 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                  <span className="text-4xl text-black">{avantages[1].icon}</span>
                </div>
            ...
            >
              <div className="flex items-start gap-6">
                <div className="w-16 h-16 bg-yellow-400 rounded-2xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
                  <span className="text-4xl text-black">{avantages[2].icon}</span>
                </div>
                <div className="flex-1">
                  <div className="text-6xl font-black text-white/10 mb-2">03</div>
            ...
            >
              <div className="flex items-start gap-6">
                <div className="w-16 h-16 bg-yellow-400 rounded-2xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
                  <span className="text-4xl text-black">{avantages[3].icon}</span>
                </div>
                <div className="flex-1">
      ...
      <section className="py-32 bg-white relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-[0.06]">
          <div className="absolute top-1/4 left-0 right-0 h-px bg-yellow-400" style={{
            backgroundImage: 'repeating-linear-gradient(to right, #FFD600 0px, #FFD600 60px, transparent 60px, transparent 100px)'
          }} />
          <div className="absolute top-3/4 left-0 right-0 h-px bg-yellow-400" style={{
            backgroundImage: 'repeating-linear-gradient(to right, #FFD600 0px, #FFD600 60px, transparent 60px, transparent 100px)'
          }} />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-24">
            ...
            >
              <div className="inline-flex items-center gap-3 px-4 py-2 bg-yellow-400/10 border border-yellow-400/20 rounded-full mb-6">
                ...
                <span className="text-yellow-700 text-sm font-bold uppercase tracking-wider">Notre Couverture</span>
              </div>
              <h2 className="text-5xl md:text-7xl font-black text-black mb-6 leading-tight">
                Zone d&apos;Intervention
              </h2>
              <p className="text-xl text-gray-600 leading-relaxed">
                GL Marquage intervient dans toute la région <strong className="text-black">Auvergne-Rhône-Alpes</strong> et en <strong className="text-black">Suisse</strong> pour tous vos projets de signalisation et d&apos;aménagement urbain
              </p>
            </motion.div>
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-yellow-400/20 to-yellow-500/10 rounded-3xl border-4 border-yellow-400/30 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <div className="text-2xl font-black text-black">Rhône-Alpes</div>
          ...
          <div className="relative mb-24">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
              {[
                { code: '73', name: 'Savoie', primary: true, description: 'Zone prioritaire', cities: 'Chambéry, Aix-les-Bains' },
                { code: '74', name: 'Haute-Savoie', primary: true, description: 'Zone prioritaire', cities: 'Annecy, Annemasse' },
                { code: '01', name: 'Ain', primary: false, description: 'Intervention régulière', cities: 'Bourg-en-Bresse, Belley' },
                { code: '38', name: 'Isère', primary: false, description: 'Intervention régulière', cities: 'Grenoble, Vienne' }
              ].map((zone, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
                ...
                >
                  ...
                  <div className={`relative p-8 rounded-3xl transition-all duration-500 ${
                    ...
                    <div className={`absolute bottom-0 left-0 right-0 h-1 rounded-b-3xl ${
                      zone.primary ? 'bg-black' : 'bg-yellow-400 opacity-0 group-hover:opacity-100 transition-opacity'
                    }`} />
                  </div>
                </motion.div>
              ))}
          ...
          >
            {[
              ...
              <div key={i} className="text-center p-6 bg-white rounded-2xl border border-gray-200 hover:border-yellow-400 transition-colors">
      ...
      <section id="realisations" className="py-32 bg-gray-100 relative overflow-hidden">
        {/* Dot Grid Pattern */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-end mb-20">
            ...
            >
              <div className="inline-flex items-center gap-3 px-4 py-2 bg-black/5 border border-black/10 rounded-full mb-6">
                ...
                <span className="text-black text-sm font-bold uppercase tracking-wider">Portfolio</span>
              </div>
            ...
            >
              <p className="text-xl md:text-2xl text-gray-600 leading-relaxed mb-8">
                Découvrez nos derniers chantiers de <span className="text-black font-bold">marquage routier</span>,
                <span className="text-black font-bold"> signalisation</span> et <span className="text-black font-bold">aménagement urbain</span> réalisés
                en <span className="text-yellow-600 font-bold">Savoie</span> et <span className="text-yellow-600 font-bold">Haute-Savoie</span>
              </p>
              <div className="flex flex-wrap gap-3 lg:justify-end">
                {['Marquage au sol', 'Signalisation', 'Mobilier urbain'].map((tag, i) => (
                  <div key={i} className="px-4 py-2 bg-yellow-400/10 border border-yellow-400/30 rounded-full text-sm font-bold text-black">
                    {tag}
                  </div>
                ))}
              </div>
          ...
          <div className="grid grid-cols-12 gap-4 lg:gap-6 mb-16">
            ...
            >
              <div className="relative h-[200px] lg:h-[290px]">
                ...
                <div className="absolute bottom-4 left-4 right-4 text-white">
                  <div className="text-sm font-bold text-yellow-400 mb-1">VOIRIE</div>
            ...
            >
              <div className="relative h-[200px] lg:h-[290px]">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-80" />
                <div className="absolute bottom-4 left-4 right-4 text-white">
                  <div className="text-sm font-bold text-yellow-400 mb-1">INDUSTRIEL</div>
            ...
            >
              <div className="relative h-[200px] lg:h-[280px]">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-80" />
                <div className="absolute bottom-4 left-4 right-4 text-white">
                  <div className="text-sm font-bold text-yellow-400 mb-1">SIGNALISATION</div>
            ...
            >
              <div className="relative h-[200px] lg:h-[280px]">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-80" />
                <div className="absolute bottom-4 left-4 right-4 text-white">
                  <div className="text-sm font-bold text-yellow-400 mb-1">DÉCORATIF</div>
            ...
            >
              <div className="relative h-[200px] lg:h-[280px]">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-80" />
                <div className="absolute bottom-4 left-4 right-4 text-white">
                  <div className="text-sm font-bold text-yellow-400 mb-1">MOBILIER</div>
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-4">
              {[
                ...
                <div key={i} className="text-center p-6 bg-white rounded-2xl border-2 border-gray-200 hover:border-yellow-400 transition-colors">
                  <div className="text-4xl font-black text-yellow-600 mb-1">{stat.number}</div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
            ...
            >
              <div className="inline-flex items-center gap-3 px-4 py-2 bg-yellow-400/10 border border-yellow-400/20 rounded-full mb-6">
                <div className="w-2 h-2 bg-yellow-400 rounded-full animate-pulse" />
                <span className="text-yellow-400 text-sm font-bold uppercase tracking-wider">Parlons de votre projet</span>
              </div>
              ...
              <p className="text-xl md:text-2xl text-gray-300 leading-relaxed mb-8">
                Obtenez un <span className="text-yellow-400 font-bold">devis gratuit sous 24h</span> et bénéficiez
                de notre expertise pour tous vos projets de signalisation.
              </p>
            ...
            >
              ...
              {[
                ...
                >
                  <div className={`w-16 h-16 rounded-xl flex items-center justify-center flex-shrink-0 transition-transform group-hover:scale-110 ${
                    contact.primary
                  ...
                  <div className="flex-1">
                    ...
                    <div className={`text-xl lg:text-2xl font-black mb-1 ${
              ...
              >
                ...
                <div>
                  <div className="text-sm text-gray-400 mb-1">Besoin d&apos;aide pour choisir ?</div>
                  <p className="text-white text-sm leading-relaxed">
                    Notre équipe vous conseille gratuitement sur le meilleur choix de signalisation pour votre projet.
                  </p>
                </div>
              </motion.div>
            </motion.div>
          ...
          >
            {[
              ...
              <div key={i} className="text-center">
                ...
                <div className="text-sm text-gray-400 font-bold uppercase tracking-wide">{item.text}</div>
              </div>
            ))}
          </motion.div>
        </div>
